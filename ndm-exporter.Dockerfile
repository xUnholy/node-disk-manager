...
WORKDIR /root/go/src/github.com/openebs/node-disk-manager/
...
COPY --from=build /root/go/src/github.com/openebs/node-disk-manager/bin/exporter /usr/local/bin/exporter
